...
<div class="right">
    ...
    <div class="introProduct">
        <h6><span style="color:blue;">● </span>냉장냉동</h6>
    ...
    <div class="introProduct">
        <h6><span style="color:blue;">● </span>레토르트(즉석식품)</h6>
    ...
    <div class="introProduct">
        <h6><span style="color:blue;">● </span>액상/식음료류</h6>
    ...
    <div class="introProduct">
        <h6><span style="color:blue;">● </span>분소물류</h6>
    ...
    <div class="introProduct">
        <h6><span style="color:blue;">● </span>농산물</h6>
    ...
    <div class="introProduct">
        <h6><span style="color:blue;">● </span>건조물류</h6>
    ...
    <div class="introProduct">
        <h6><span style="color:blue;">● </span>EPL필름</h6>
    ...
    <div class="introProduct">
        <h6><span style="color:blue;">● </span>콜드씰 제품</h6>
