...
<div class="right">
    ...
    <div class="introProduct" style="overflow: hidden;">
        <img src="img/product/l8.png" style="float: right; height:250px; ">
        <h6><span style="color:brown;">●</span>생활용품</h6>
    ...
    <div class="introProduct">
        <img src="img/product/l9.png" style="float: right; height: 170px; margin-top:20px;">
        <h6><span style="color:brown;">●</span>위생용품</h6>
